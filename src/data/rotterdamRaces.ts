    ...
    cities: [
      {
        ...
        races: [
          ...
          },
          {
            ...
            description: 'Een van de snelste marathons ter wereld, met NN als hoofdsponsor. Plat parcours door het hart van Rotterdam, erkend als World Athletics Platinum Label. De ultieme test voor iedere hardloper.',
            location: 'Rotterdam Centrum',
            accentColor: '#F25011',
            registrationOpen: false,
            featured: true,
          },
          {
            ...
            name: 'Bruggenloop Rotterdam',
            date: '2026-12-13',
            distance: '15km',
            url: 'https://bruggenloop.nl',
            description: 'Winterse, door DSW gesponsorde 15 km over de iconische bruggen van Rotterdam, met start bij Stadion Feijenoord (De Kuip). Sfeervolle avondloop langs de verlichte skyline, jaarlijks snel uitverkocht.',
      ...
      },
      {
        ...
        races: [
          ...
          },
          {
            ...
            name: 'Marathon Den Haag',
            date: '2026-11-01',
            distance: 'marathon',
            url: 'https://nnmarathonthehague.nl/en/',
            description: 'Gloednieuw, door NN gesponsord evenement op 1 november 2026. Loop door Den Haag langs paleizen, parken en de boulevard van Scheveningen. Kies uit marathon, 10 km of 5 km.',
            ...
            subRaces: [
              {
                ...
                name: 'Marathon Den Haag - Marathon',
                date: '2026-11-01',
                distance: 'marathon',
                url: 'https://nnmarathonthehague.nl/en/nn-marathon-the-hague/',
                description: 'De volledige 42,195 km door Den Haag, gesponsord door NN. Een historisch eerste editie.',
                location: 'Den Haag Centrum',
                accentColor: '#EF4444',
                registrationOpen: true,
              },
              {
                ...
                name: 'Marathon Den Haag - 10 km',
                date: '2026-11-01',
                distance: '10km',
                url: 'https://nnmarathonthehague.nl/en/nn-the-hague-10k/',
                description: 'Snelle 10 km door het centrum van Den Haag, gesponsord door NN, op hetzelfde parcours als de marathon.',
                location: 'Den Haag Centrum',
                accentColor: '#F97316',
                registrationOpen: true,
              },
              {
                ...
                name: 'Marathon Den Haag - 5 km',
                date: '2026-11-01',
                distance: '5km',
                url: 'https://nnmarathonthehague.nl/en/the-hague-5k/',
                description: 'Toegankelijke 5 km voor beginners en recreatieve lopers, gesponsord door NN. Perfect als eerste wedstrijd.',
                location: 'Den Haag Centrum',
                accentColor: '#22C55E',
                registrationOpen: true,
              },
      ...
      },
      {
        ...
        races: [
          ...
          },
          {
            ...
            name: 'Dordrecht Halve Marathon',
            date: '2027-03-13',
            distance: 'half_marathon',
            url: 'https://boelsrentalrun.nl',
            description: 'Klassiek voorjaarsevenement in Dordrecht met 5 km, 10 km en halve marathon. Snel en vlak parcours door de binnenstad. Het evenement wordt georganiseerd onder de naam Boels Rental Run, voorheen de Riwal Hoogwerkers Halve Marathon.',
            location: 'Dordrecht',
            accentColor: '#0D9488',
            registrationOpen: false,
          },
        ...
        races: [
          {
            ...
            description: 'Populair, door Moore DRV gesponsord hardloopevenement in het Westland met 5 km, 10 km en halve marathon. Finish bij sportpark De Hoge Bomen in Naaldwijk. Vorige editie volledig uitverkocht.',
            ...
            subRaces: [
              {
                ...
                name: 'Spijkenisse Marathon - Marathon',
                date: '2026-11-29',
                distance: 'marathon',
                url: 'https://inschrijven.nl/form/2026112909236',
                description: 'De volledige 42,195 km door Spijkenisse, georganiseerd door atletiekvereniging AV Spark.',
                location: 'Spijkenisse',
                accentColor: '#E11D48',
                registrationOpen: true,
              },
              {
                ...
                name: 'Spijkenisse Marathon - Halve Marathon',
                date: '2026-11-29',
                distance: 'half_marathon',
                url: 'https://inschrijven.nl/form/2026112909236',
                description: 'Halve marathon van 21,1 km door Spijkenisse, onderdeel van de door AV Spark georganiseerde Spijkenisse Marathon.',
                location: 'Spijkenisse',
                accentColor: '#F43F5E',
                registrationOpen: true,
              },
              {
                ...
                name: 'Spijkenisse Marathon - 10 km',
                date: '2026-11-29',
                distance: '10km',
                url: 'https://inschrijven.nl/form/2026112909236',
                description: '10 km door Spijkenisse, onderdeel van de door AV Spark georganiseerde Spijkenisse Marathon.',
                location: 'Spijkenisse',
                accentColor: '#FB7185',
                registrationOpen: true,
              },
              {
                ...
                name: 'Spijkenisse Marathon - 5 km',
                date: '2026-11-29',
                distance: '5km',
                url: 'https://inschrijven.nl/form/2026112909236',
                description: 'Toegankelijke 5 km door Spijkenisse, onderdeel van de door AV Spark georganiseerde Spijkenisse Marathon.',
                location: 'Spijkenisse',
                accentColor: '#FDA4AF',
                registrationOpen: true,
              },
        ...
        races: [
          {
            ...
            description: 'De 40e editie van deze door NN gesponsorde iconische 10 mijl (16 km) van Amsterdam naar Zaandam. Uitverkocht voor 2026, maar een perfect trainingsdoel.',
          ...
          },
          {
            ...
            description: 'Iconische, door TCS gesponsorde marathon door het hart van Amsterdam, met start en finish in het Olympisch Stadion. Ook een halve marathon beschikbaar.',
            ...
            subRaces: [
              {
                ...
                name: 'Amsterdam Marathon - Marathon',
                date: '2026-10-18',
                distance: 'marathon',
                url: 'https://www.tcsamsterdammarathon.nl/inschrijven',
                description: 'De volledige 42,195 km door Amsterdam, met TCS als hoofdsponsor. Inschrijving sluit 5 oktober 2026.',
                location: 'Olympisch Stadion, Amsterdam',
                accentColor: '#DB2777',
                registrationOpen: true,
              },
              {
                ...
                name: 'Amsterdam Marathon - Halve Marathon',
                date: '2026-10-18',
                distance: 'half_marathon',
                url: 'https://www.tcsamsterdammarathon.nl/inschrijven',
                description: 'Halve marathon van 21,1 km door Amsterdam, onderdeel van de door TCS gesponsorde Amsterdam Marathon, op hetzelfde parcours als de marathon.',
                location: 'Olympisch Stadion, Amsterdam',
                accentColor: '#EC4899',
                registrationOpen: true,
              },
        ...
        races: [
          {
            ...
            name: 'Egmond Halve Marathon',
            date: '2027-01-10',
            distance: 'half_marathon',
            url: 'https://www.egmondhalvemarathon.nl',
            description: 'Een van de zwaarste halve marathons van Nederland, met NN als hoofdsponsor. Strand, duinen en hoogtemeters langs de Noordzeekust bij Egmond aan Zee. Inschrijving opent medio augustus 2026.',
        ...
        races: [
          {
            ...
            description: 'Het grootste hardloopevenement van Tilburg, gesponsord door CZ. 10 Engelse mijl (16,1 km) dwars door de stad, plus 10 km en 5 km. Jaarlijks op de laatste zondag van september.',
            ...
            subRaces: [
              {
                ...
                name: 'Tilburg Ten Miles - 10 Mijl',
                date: '2026-09-27',
                distance: '15km',
                url: 'https://tilburgtenmiles.nl/inschrijven/',
                description: '10 Engelse mijl (16,1 km) dwars door Tilburg, gesponsord door CZ. Het iconische hoofdonderdeel.',
                location: 'Tilburg Centrum',
                accentColor: '#7C3AED',
                registrationOpen: true,
              },
              {
                ...
                name: 'Tilburg Ten Miles - 10 km',
                date: '2026-09-27',
                distance: '10km',
                url: 'https://tilburgtenmiles.nl/inschrijven/',
                description: '10 km door het centrum van Tilburg, gesponsord door CZ.',
                location: 'Tilburg Centrum',
                accentColor: '#8B5CF6',
                registrationOpen: true,
              },
              {
                ...
                name: 'Tilburg Ten Miles - 5 km',
                date: '2026-09-27',
                distance: '5km',
                url: 'https://tilburgtenmiles.nl/inschrijven/',
                description: 'Toegankelijke 5 km voor alle niveaus, gesponsord door CZ.',
                location: 'Tilburg Centrum',
                accentColor: '#A78BFA',
                registrationOpen: true,
              },
        ...
        races: [
          {
            ...
            description: 'Een van de grootste hardloopevenementen van Nederland met 38.000 deelnemers, gesponsord door ASML. Vlak parcours door Eindhoven, met afstanden van 5 km tot marathon.',
            ...
            subRaces: [
              {
                ...
                name: 'Marathon Eindhoven - Marathon',
                date: '2026-10-11',
                distance: 'marathon',
                url: 'https://asmlmarathoneindhoven.nl/en/register/',
                description: 'De volledige 42,195 km, gesponsord door ASML. Snel en vlak parcours. Inschrijving: €95 (eerste 1.500 deelnemers).',
                location: 'Vestdijk, Eindhoven',
                accentColor: '#EA580C',
                registrationOpen: true,
              },
              {
                ...
                name: 'Marathon Eindhoven - Halve Marathon',
                date: '2026-10-11',
                distance: 'half_marathon',
                url: 'https://asmlmarathoneindhoven.nl/en/register/',
                description: 'Halve marathon van 21,1 km, onderdeel van de door ASML gesponsorde Marathon Eindhoven. Een van de populairste afstanden van het evenement.',
                location: 'Vestdijk, Eindhoven',
                accentColor: '#F97316',
                registrationOpen: true,
              },
              {
                ...
                name: 'Marathon Eindhoven - 10 km',
                date: '2026-10-11',
                distance: '10km',
                url: 'https://asmlmarathoneindhoven.nl/en/register/',
                description: '10 km door het centrum van Eindhoven, gesponsord door ASML.',
                location: 'Vestdijk, Eindhoven',
                accentColor: '#FB923C',
                registrationOpen: true,
              },
              {
                ...
                name: 'Marathon Eindhoven - 5 km',
                date: '2026-10-11',
                distance: '5km',
                url: 'https://asmlmarathoneindhoven.nl/en/register/',
                description: 'Toegankelijke 5 km, gesponsord door ASML. Ideaal voor beginners of als warming-up voor het evenement.',
                location: 'Vestdijk, Eindhoven',
                accentColor: '#FDBA74',
                registrationOpen: true,
              },
        ...
        races: [
          {
            ...
            description: 'De oudste stratenloop van Nederland, gesponsord door TREK, langs de Utrechtse singels en grachten. Start en finish bij het Domplein. 5 km en 10 km beschikbaar.',
            ...
            subRaces: [
              {
                ...
                description: '10 km langs de singels en grachten van Utrecht, gesponsord door TREK.',
                location: 'Domplein, Utrecht',
                accentColor: '#0369A1',
                registrationOpen: true,
              },
              {
                ...
                name: 'Singelloop Utrecht - 5 km',
                date: '2026-10-04',
                distance: '5km',
                url: 'https://singellooputrecht.nl/inschrijven/',
                description: '5 km door de historische binnenstad van Utrecht, gesponsord door TREK.',
                location: 'Domplein, Utrecht',
                accentColor: '#0EA5E9',
                registrationOpen: true,
              },
        ...
        races: [
          {
            ...
            description: 'Iconische, door Garmin gesponsorde 15 km over de heuvels van Nijmegen, Groesbeek en Berg en Dal. Een van de meest uitdagende lopen van Nederland, jaarlijks snel uitverkocht.',
            location: 'Nijmegen',
            accentColor: '#84CC16',
            registrationOpen: true,
          },
        ...
        races: [
          {
            ...
            description: '20e editie van de door Arrow gesponsorde Venloop door Venlo, met halve marathon, 10 km en 5 km. De halve marathon is doorgaans binnen enkele dagen uitverkocht, dus wees er op tijd bij.',
            location: 'Venlo',
            accentColor: '#EA580C',
            registrationOpen: false,
            subRaces: [
              {
                id: 'arrow-venloop-2027-hm',
                name: 'Venloop - Halve Marathon',
                date: '2027-03-21',
                distance: 'half_marathon',
                url: 'https://venloop.nl/en/running/arrow-venloop/',
                description: 'De hoofdafstand van de door Arrow gesponsorde Venloop: 21,1 km door Venlo. Doorgaans snel uitverkocht.',
                location: 'Venlo',
                accentColor: '#EA580C',
                registrationOpen: false,
              },
              {
                id: 'arrow-venloop-2027-10km',
                name: 'Venloop - 10 km',
                date: '2027-03-21',
                distance: '10km',
                url: 'https://venloop.nl/en/running/arrow-venloop/',
                description: '10 km door het centrum van Venlo, onderdeel van de door Arrow gesponsorde Venloop.',
                location: 'Venlo',
                accentColor: '#F97316',
                registrationOpen: false,
              },
              {
                id: 'arrow-venloop-2027-5km',
                name: 'Venloop - 5 km',
                date: '2027-03-21',
                distance: '5km',
                url: 'https://venloop.nl/en/running/arrow-venloop/',
                description: 'Toegankelijke 5 km voor alle niveaus, onderdeel van de door Arrow gesponsorde Venloop.',
                location: 'Venlo',
                accentColor: '#FB923C',
                registrationOpen: false,
              },
        ...
        races: [
          {
            ...
            description: 'Door Athora gesponsord evenement met een vlak en snel parcours door de historische binnenstad van Brugge, via Zeebrugge, met finish op de Grote Markt.',
            ...
            subRaces: [
              {
                ...
                name: 'Bruges Marathon - Marathon',
                date: '2026-10-11',
                distance: 'marathon',
                url: 'https://athorabrugesmarathon.com/en/',
                description: "De volledige 42,195 km door Brugge, gesponsord door Athora, van 't Zand via Zeebrugge naar de Grote Markt.",
                location: 'Grote Markt, Brugge',
                accentColor: '#0D9488',
                registrationOpen: true,
              },
              {
                ...
                name: 'Bruges Marathon - Halve Marathon',
                date: '2026-10-11',
                distance: 'half_marathon',
                url: 'https://athorabrugesmarathon.com/en/',
                description: 'Halve marathon van 21,1 km door de historische binnenstad van Brugge, gesponsord door Athora, met finish op de Grote Markt.',
                location: 'Grote Markt, Brugge',
                accentColor: '#2DD4BF',
                registrationOpen: true,
              },
        ...
        races: [
          {
            ...
            description: 'Populairste, door MAES gesponsorde loopfeest van Gent, met een parcours langs culturele hoogtepunten en een afterparty met live muziek.',
            ...
            subRaces: [
              {
                ...
                name: 'Gent 10 Mijl - 10 Mijl',
                date: '2026-09-20',
                distance: '15km', // 10 mijl = 16,61 km; dichtstbijzijnde type
                url: 'https://maesgent10mijl.be/',
                description: 'De hoofdafstand van 10 mijl (16,61 km), gesponsord door MAES, met start bij Parking Oost en finish bij Sport Vlaanderen Gent.',
              ...
              },
              {
                ...
                name: 'Gent 10 Mijl - 5 Mijl',
                date: '2026-09-20',
                distance: '10km', // 5 mijl = 8,45 km; dichtstbijzijnde type
                url: 'https://maesgent10mijl.be/',
                description: '5 mijl (8,45 km) door Gent, gesponsord door MAES, langs culturele hoogtepunten.',
                location: 'Zuiderlaan, Gent',
                accentColor: '#FDE047',
                registrationOpen: true,
              },
        ...
        races: [
          {
            ...
            description: 'Grootste, door TREK gesponsorde loopwedstrijd van Antwerpen met 20.000+ deelnemers, door de haven, tunnels en historische binnenstad. Finish bij het MAS.',
            ...
            subRaces: [
              {
                ...
                name: 'Antwerp Marathon - Marathon',
                date: '2026-10-18',
                distance: 'marathon',
                url: 'https://antwerpmarathon.com/en/',
                description: 'De volledige 42,195 km door Antwerpen, gesponsord door TREK, langs de haven en tunnels naar de finish bij het MAS.',
              ...
              },
              {
                ...
                name: 'Antwerp Marathon - Halve Marathon',
                date: '2026-10-18',
                distance: 'half_marathon',
                url: 'https://antwerpmarathon.com/en/',
                description: 'Halve marathon van 21,1 km door Antwerpen, gesponsord door TREK, met finish bij het MAS.',
                location: 'Kattendijkbrug → MAS, Antwerpen',
                accentColor: '#F87171',
                registrationOpen: true,
              },
              {
                ...
                name: 'Antwerp Marathon - 10 km',
                date: '2026-10-18',
                distance: '10km',
                url: 'https://antwerpmarathon.com/en/',
                description: '10 km door de binnenstad van Antwerpen, gesponsord door TREK, start aan de Orteliuskaai.',
          ...
          },
          {
            ...
            name: 'Antwerp 10 Miles',
            date: '2027-04-18',
            distance: '15km', // 10 mijl = 16,09 km; dichtstbijzijnde type
            url: 'https://baloiseantwerp10miles.be/en/',
            description: 'Populair, door Baloise gesponsord hardloopevenement door Antwerpen met een parcours door de Kennedytunnel. De vorige editie was binnen twee dagen uitverkocht met 50.000 deelnemers.',
            location: 'Antwerpen',
            accentColor: '#2563EB',
            registrationOpen: false,
            subRaces: [
              {
                ...
                name: 'Antwerp 10 Miles - 10 Miles',
                date: '2027-04-18',
                distance: '15km', // 10 mijl = 16,09 km; dichtstbijzijnde type
                url: 'https://baloiseantwerp10miles.be/en/',
                description: 'De hoofdafstand van 10 mijl (16,09 km) door Antwerpen, gesponsord door Baloise, via de Kennedytunnel.',
                location: 'Antwerpen',
                accentColor: '#2563EB',
                registrationOpen: false,
              },
              {
                ...
                name: 'Antwerp 10 Miles - 5 Miles',
                date: '2027-04-17',
                distance: '10km', // 5 mijl = 8,05 km; dichtstbijzijnde type
                url: 'https://baloiseantwerp10miles.be/en/',
                description: '5 mijl (8,05 km) door Antwerpen, gesponsord door Baloise, op zaterdag voorafgaand aan de hoofdafstand.',
                location: 'Antwerpen',
                accentColor: '#60A5FA',
                registrationOpen: false,
              },
